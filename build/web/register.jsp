<html>
    <head>
       ...
       <body>
           ...
           <div class="container">
               <div class="content">
                   <form name="reg" action="reg.jsp" method="post" onsubmit="return check()">
                       <div class="top">
                           <div class="left">
                             Register Now...
                           </div>
                       ...
                       <div class="data4">
                           <input type="checkbox" id="c1" value="yes">I'm not a robot</input>
                        <br>
                        <input type="checkbox" id="c2" value="yes">Accept the term & Policy</input>
                        <br>
           ...
           <script>
               function check()
               {
                   ...
                   {
                       alert('plese fill the require feilds..');
                    return false;
